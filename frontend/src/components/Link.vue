<template>
  <div v-if="!field.hidden" class="w-full">
    <div v-if="matrix" class="overflow-x-auto">
      <div class="inline-block min-w-full py-2 align-middle">
        <div class="overflow-hidden rounded-lg">
          ...
          <p v-if="index < 1 && (parsedDescription.cenrieo || fieldParsedDescription.cenrieo) && !isCard" class="text-sm text-gray-500">
    ...
    <div v-else>
      <p
        v-if="parsedDescription.qlable || fieldParsedDescription.qlable && !isCard"
        class="text-md font-medium text-gray-900 dark:text-gray-200"
      >
        {{ parsedDescription.qlable || fieldParsedDescription.qlable }}
      </p>
      <p
        v-if="parsedDescription.cenrieo || fieldParsedDescription.cenrieo && !isCard"
      ...
      <p
        v-if="parsedDescription.desc || fieldParsedDescription.desc && !isCard"
