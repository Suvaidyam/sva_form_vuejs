    ...
    <div class="inline-block min-w-full p-2 align-middle">
      <div class="overflow-hidden rounded-lg ">
        <div class="grid gap-x-4" :style="gridTemplateColumns">
          ...
          <div
            class="bg-white font-medium dark:bg-gray-900 py-1 px-3 flex items-start border-t border-gray-200 dark:border-gray-700 min-h-[80px]">
            <div class="w-full pr-6">
              <div class="flex items-start justify-between">
                <label :for="`${field.name}-${visibleOptions[0]?.name}`" class="flex items-start">
                  <span class="mr-2 text-md font-medium text-gray-900 dark:text-gray-200 block">
                    {{ field.label }}
              ...
              <p v-if="fieldParsedDescription.desc" class="text-sm text-gray-600 dark:text-gray-400 mt-1">
